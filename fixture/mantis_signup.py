...
class MantisSignUpHelper:
    ...
    def new_user(self, username, email, password):
        ...
        wd.find_element_by_xpath(".//input[@type='submit'][@value='Signup']").click()
        ...
        wd.find_element_by_xpath(".//input[@type='submit'][@value='Update User']").click()
